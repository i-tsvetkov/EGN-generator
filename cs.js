...
var combinations, combinationsWithRepetitions, egnPermutations, fixWrongDigits, generateRandomPattern, generateRandomRangePattern, generateRandomStarPattern, getEgnsFromModel, getPatternsFromRangeModel, getRandomEgn, getRandomNumbers, parseRange, permutations, product, remove, starPattern, swapTwoDigits, tooManyDigits, tryFixIt,
  slice = [].slice,
...
generateRandomRangePattern = function(pattern) {
  ...
  rs = pattern.match(/\[\d+-\d+\]/g).map(function(r) {
